/* Automatically generated from Squeak on 19 January 2011 4:30:03 pm 
   by VMMaker 3.11.13
 */
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"InternetConfigPlugin 19 January 2011 (i)"
#else
	"InternetConfigPlugin 19 January 2011 (e)"
#endif
;
...
EXPORT(sqInt) primitiveGetMacintoshFileTypeAndCreatorFrom(void) {
	...
	keyLength = interpreterProxy->byteSizeOf((oopForPointer( aFileName ) - 4));
...
EXPORT(sqInt) primitiveGetStringKeyedBy(void) {
	...
	keyLength = interpreterProxy->byteSizeOf((oopForPointer( aKey ) - 4));
