/* Automatically generated from Squeak on 29 March 2011 5:54:52 pm 
   by VMMaker 3.11.13
 */
...
register struct foo * foo = &fum;
	...
	foo->stackPointer -= BytesPerWord;
	thisObject = top1;
	if (internalIsHandle(thisObject)) {
		thisObject = longAt((thisObject + BaseHeaderSize) + (HandleReceiverIndex << ShiftForWord));
	}
	/* begin pushBool: */
